...
class _CodiaPageState extends State<CodiaPage> {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                // Show message if no food cards are available
                if (!_isLoading && _foodCards.isEmpty)
                  Padding(
                    padding: const EdgeInsets.symmetric(
                        horizontal: 29, vertical: 20),
                    child: Center(
                      child: Text(
                        'No recent meals. Try using the Snap Meal feature!',
                        style: TextStyle(
                          fontSize: 16,
                ...
                if (!_isLoading)
                  ..._foodCards
                      .map((foodCard) => _buildFoodCard(foodCard))
                      .toList(),
    ...
    return Padding(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              // Food image (actual image or placeholder)
              imageWidget,
  ...
  // Build the default image container when no image is available
